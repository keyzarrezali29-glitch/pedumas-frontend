        ...
        <div style={{ position:"relative", zIndex:10, display:"flex", alignItems:"center", justifyContent:"space-between", gap:32 }}>
          <div>
            <div style={{ display:"inline-flex", alignItems:"center", gap:8, background:"rgba(255,255,255,.2)", padding:"6px 14px", borderRadius:100, fontSize:12, fontWeight:700, marginBottom:16 }}>
              <ShieldCheck size={14} /> PEDUMAS PROFILE
            </div>
            <h1 style={{ fontSize:40, fontWeight:800, marginBottom:10, lineHeight:1.2 }}>Profile User</h1>
            <p style={{ color:"rgba(255,255,255,.75)", fontSize:15, lineHeight:1.7, maxWidth:480 }}>
              Kelola informasi akun, keamanan profile, dan personalisasi akun PEDUMAS.
            </p>
          </div>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"1fr 2fr", gap:24 }}>
        ...
        <div style={{ background:"white", borderRadius:24, padding:28, border:`1.5px solid ${R.light}`, boxShadow:"0 4px 20px rgba(0,0,0,.05)", alignSelf:"start" }}>
          <div style={{ display:"flex", flexDirection:"column", alignItems:"center", textAlign:"center" }}>
            ...
            <span style={{ background:R.light, color:R.main, padding:"6px 16px", borderRadius:100, fontSize:12, fontWeight:700 }}>
              USER MASYARAKAT
            </span>

            {/* STATS */}
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:12, marginTop:24, width:"100%" }}>
              <div style={{ background:R.light, borderRadius:14, padding:"16px 12px", textAlign:"center" }}>
                <div style={{ fontSize:28, fontWeight:800, color:R.main }}>24</div>
                <div style={{ fontSize:12, color:R.muted, marginTop:4 }}>Activity</div>
              </div>
              <div style={{ background:"#D1FAE5", borderRadius:14, padding:"16px 12px", textAlign:"center" }}>
        ...
        <div style={{ background:"white", borderRadius:24, padding:28, border:`1.5px solid ${R.light}`, boxShadow:"0 4px 20px rgba(0,0,0,.05)" }}>
          ...
          <p style={{ fontSize:14, color:R.muted, marginBottom:28 }}>Update informasi profile akun kamu.</p>

          <form onSubmit={handleUpdate} style={{ display:"flex", flexDirection:"column", gap:20 }}>

            <div>
              <label style={labelStyle}><User2 size={16} color={R.main} /> Nama Lengkap</label>
              <input className="pfield" style={inputStyle} type="text" value={name} onChange={e => setName(e.target.value)} required />
            </div>
